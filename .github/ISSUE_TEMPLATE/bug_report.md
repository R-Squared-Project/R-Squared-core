---
name: Bug Report
about: Create a detailed report about a deficiency in the R-Squared Core implementation.
...
**Impacts**
Describe which portion(s) of R-Squared Core may be impacted by this bug. Please tick at least one box.
...
Please provide details about the host environment. Much of this information can be found running: `witness_node --version`. 
 ...
 - R-Squared Core Version:   [e.g. 1.0.0]
